...
# Additional Mount into Container (additional-mount)

Mount multiple host paths into container (source/target are controlled by local environment variables)

## Example Usage

```json
"features": {
    "ghcr.io/tanihiroki/devcontainer-features/additional-mount:1": {}
}
```
...
_Note: This file was auto-generated from the [devcontainer-feature.json](https://github.com/tanihiroki/devcontainer-features/blob/main/src/additional-mount/devcontainer-feature.json).  Add additional notes to a `NOTES.md`._
